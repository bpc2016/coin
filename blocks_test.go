...
func TestBlockHeader(t *testing.T) {
	testVersion := 2
	testPrevBlock := "000000000000000117c80378b8da0e33559b5997f2ad55e2f7d18ec1975b9717"
	testTimeStamp := 0x53058b35
	testBits := 0x19015f53
	bh, err := BlockHeader(testVersion, testPrevBlock, testTimeStamp, testBits)
	if err != nil {
		t.Error(err)
	}
...
var mRoot = "871714dcbae6c8193a2bb9b2a69fe1c0440399f38d94b3a0f1b447275a29978a"
var txHashes = []string{
...
func TestMerkle(t *testing.T) {
	...
	mr, skel, err := Merkle(coinbase, txns)
	if err != nil {
		t.Error(err)
	}
	hexgot := fmt.Sprintf("%x", mr)
	if hexgot != mRoot {
		t.Errorf("\nExp: %v\nGot: %v\n", mRoot, hexgot)
	}
